		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center fw-bold  text-primary">User
							Register</p>

						<c:if test="${not empty sucMsg }">
							<p class="text-center text-success fs-5 fw-bold">${sucMsg }</p>
						...
						<form action="user_register" method="post">
							...
							<button type="submit" class="btn bg-mycolor text-white col-md-12">Register</button>
						</form>
					</div>
				</div>
			</div>
